...
class __TwigTemplate_f6044c238a5b0dee60c619f2512cdeba extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {{ form_widget(form.name,{'attr':{'class':'form form-control'}}) }}<br><br>
    <button class=\"btn btn-primary\">{{ button_label|default('Save') }}</button><br><br>
{{ form_end(form) }}
", "category/_form.html.twig", "/Applications/MAMP/htdocs/projet/news-application/templates/category/_form.html.twig");
    }
}
