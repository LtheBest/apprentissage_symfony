...
return [
    ...
    'app_new_show' => [['id'], ['_controller' => 'App\\Controller\\HomepageController::newsShow'], ['id' => '[0-9]+'], [['variable', '/', '[0-9]+', 'id', true], ['text', '/news']], [], [], []],
    'app_new_by_category_show' => [['id'], ['_controller' => 'App\\Controller\\HomepageController::NewsByCategory'], ['id' => '[0-9]+'], [['text', '/category'], ['variable', '/', '[0-9]+', 'id', true], ['text', '/news']], [], [], []],
